package com.gouzhong1223.wxmptest.util;

import com.gouzhong1223.wxmptest.constant.SystemConstant;
 ...
 * @Description :
 * @Date : create by QingSong in 2020-10-25 16:50
 * @Email : gouzhong1223@gmail.com
 * @Since : JDK 1.8
 * @PackageName : com.gouzhong1223.wxmptest.util
...
//        log.info(result);
    ...
    public static String setParmas(String url, Map<String, String> map, String charset) throws Exception {
        ...
        if (StringUtils.isNotEmpty(url) && map.size() != 0) {
